...
filenames \texttt{~/.emacs}, \texttt{~/.emacs.el}, and
\texttt{~/.emacs.d/init.el}; you can choose to use any one of these three names.
Here, \texttt{~/} stands for your home directory
...
For users with a single monitors, we recommend \texttt{horizontal}, and if two
